...
idf_build_set_property(PARTITION_TABLE_PATH "${project_dir}/driver/jeejioxie_esp32c3/chip/storage/partition_table")
...
if(NOT BOOTLOADER_BUILD)
    ...
    if(CONFIG_PARTITION_TABLE_CUSTOM)
        ...
        idf_build_get_property(partition_table_path PARTITION_TABLE_PATH)
        ...
        get_filename_component(PARTITION_CSV_PATH "${CONFIG_PARTITION_TABLE_FILENAME}"
                                ABSOLUTE BASE_DIR "${partition_table_path}")
...
function(partition_table_get_partition_info result get_part_info_args part_info)
    ...
    execute_process(COMMAND ${python}
        ${jeejio_path}/driver/jeejioxie_esp32c3/chip/storage/partition_table/parttool.py -q
