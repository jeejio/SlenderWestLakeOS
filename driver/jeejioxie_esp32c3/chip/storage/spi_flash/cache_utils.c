...
#elif CONFIG_JEEJIO_TARGET_ESP32C3 || CONFIG_JEEJIO_TARGET_ESP32H2 || CONFIG_JEEJIO_TARGET_ESP32C2
...
#elif CONFIG_JEEJIO_TARGET_ESP32S3 || CONFIG_JEEJIO_TARGET_ESP32C3 || CONFIG_JEEJIO_TARGET_ESP32H2 || CONFIG_JEEJIO_TARGET_ESP32C2
...
#if (CONFIG_JEEJIO_TARGET_ESP32S2 && CONFIG_SPIRAM)
...
#if (CONFIG_JEEJIO_TARGET_ESP32S3 && CONFIG_SPIRAM)
static IRAM_ATTR void esp_enable_cache_spiram_wrap(bool icache, bool dcache)
{
    uint32_t i_autoload, d_autoload;
    if (icache) {
...
#if CONFIG_JEEJIO_TARGET_ESP32C3 || CONFIG_JEEJIO_TARGET_ESP32H2 || CONFIG_JEEJIO_TARGET_ESP32C2
...
#endif // CONFIG_JEEJIO_TARGET_ESP32C3 || CONFIG_JEEJIO_TARGET_ESP32H2 || CONFIG_JEEJIO_TARGET_ESP32C2
