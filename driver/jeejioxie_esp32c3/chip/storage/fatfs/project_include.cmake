...
function(fatfs_create_partition_image partition base_dir)
    ...
    if(arg_WL_INIT)
        set(fatfsgen_py ${python} ${jeejio_path}/driver/jeejioxie_esp32c3/chip/storage/fatfs/wl_fatfsgen.py)
    else()
        set(fatfsgen_py ${python} ${jeejio_path}/driver/jeejioxie_esp32c3/chip/storage/fatfs/fatfsgen.py)
    endif()
