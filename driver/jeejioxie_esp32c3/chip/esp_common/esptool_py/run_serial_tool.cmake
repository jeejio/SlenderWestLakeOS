# A CMake script to run serial tool commands supporting JEEJIOPORT and
# JEEJIOBAUD environment variables from within ninja or make or another
...
if(NOT JEEJIO_PATH)
    message(FATAL_ERROR "JEEJIO_PATH not set.")
endif()
...
if(NOT JEEJIOPORT)
    ...
    list(APPEND serial_tool_cmd -p ${JEEJIOPORT})
endif()
...
if(NOT JEEJIOBAUD)
    ...
    list(APPEND serial_tool_cmd -b ${JEEJIOBAUD})
endif()
