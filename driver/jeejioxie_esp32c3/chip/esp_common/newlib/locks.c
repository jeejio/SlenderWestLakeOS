...
#elif defined(CONFIG_JEEJIO_TARGET_ESP32S2)
...
#elif defined(CONFIG_JEEJIO_TARGET_ESP32C3) || defined(CONFIG_JEEJIO_TARGET_ESP32S3) || defined(CONFIG_JEEJIO_TARGET_ESP32H2) || defined(CONFIG_JEEJIO_TARGET_ESP32C2)
