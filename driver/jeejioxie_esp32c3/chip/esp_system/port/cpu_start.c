...
#if CONFIG_JEEJIO_TARGET_ESP32
#include "soc/dport_reg.h"
#include "esp32/rtc.h"
#include "esp32/rom/cache.h"
#include "esp32/rom/secure_boot.h"
#elif CONFIG_JEEJIO_TARGET_ESP32S2
#include "esp32s2/rtc.h"
#include "esp32s2/rom/cache.h"
#include "esp32s2/rom/secure_boot.h"
#include "esp32s2/memprot.h"
#elif CONFIG_JEEJIO_TARGET_ESP32S3
...
#elif CONFIG_JEEJIO_TARGET_ESP32C3
#include "esp32c3/rtc.h"
#include "esp32c3/rom/cache.h"
#include "esp32c3/rom/secure_boot.h"
#include "esp_memprot.h"
#elif CONFIG_JEEJIO_TARGET_ESP32H2
#include "esp32h2/rtc.h"
#include "esp32h2/rom/cache.h"
#include "esp32h2/rom/secure_boot.h"
#include "esp_memprot.h"
#elif CONFIG_JEEJIO_TARGET_ESP32C2
...
#if (CONFIG_JEEJIO_TARGET_ESP32 && CONFIG_ESP32_TRAX_TWOBANKS) || \
    (CONFIG_JEEJIO_TARGET_ESP32S3 && CONFIG_ESP32S3_TRAX_TWOBANKS)
...
void IRAM_ATTR call_start_cpu0(void)
{
...
#if defined(CONFIG_JEEJIO_TARGET_ESP32) && defined(CONFIG_ESP32_IRAM_AS_8BIT_ACCESSIBLE_MEMORY)
    // Clear IRAM BSS
...
#if CONFIG_JEEJIO_TARGET_ESP32S2
...
#endif // CONFIG_JEEJIO_TARGET_ESP32S3

    if (esp_efuse_check_errors() != ESP_OK) {
        esp_restart();
    }

#if CONFIG_JEEJIO_TARGET_ESP32S3 || CONFIG_JEEJIO_TARGET_ESP32C3 || CONFIG_JEEJIO_TARGET_ESP32H2 || CONFIG_JEEJIO_TARGET_ESP32C2
...
#endif // CONFIG_JEEJIO_TARGET_ESP32S3 || CONFIG_JEEJIO_TARGET_ESP32C3 || CONFIG_JEEJIO_TARGET_ESP32H2 || CONFIG_JEEJIO_TARGET_ESP32C2
    ...
    REG_CLR_BIT(SYSTEM_CORE_1_CONTROL_0_REG, SYSTEM_CONTROL_CORE_1_RESETING);
#endif
#endif // CONFIG_JEEJIO_TARGET_ESP32
#endif // !CONFIG_ESP_SYSTEM_SINGLE_CORE_MODE
...
#if CONFIG_ESP32_TRAX || CONFIG_ESP32S2_TRAX || CONFIG_ESP32S3_TRAX
#if CONFIG_JEEJIO_TARGET_ESP32 || CONFIG_JEEJIO_TARGET_ESP32S3
...
#if CONFIG_JEEJIO_TARGET_ESP32S2 //specific for ESP32S2 unless IDF-3024 is merged
...
#endif // CONFIG_JEEJIO_TARGET_ESP32C2
