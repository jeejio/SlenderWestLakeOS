...
def main():
    global quiet
    global max_blk_len
    global jeejio_target

    parser = argparse.ArgumentParser(description='ESP32 eFuse Manager')
    parser.add_argument('--jeejio_target', '-t', help='Target chip type', choices=['esp32', 'esp32s2', 'esp32s3', 'esp32c3',
    ...
    jeejio_target = args.jeejio_target
