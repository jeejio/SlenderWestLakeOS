...
#define I2S_ENTER_CRITICAL_ISR(i2s_num)          portENTER_CRITICAL_ISR()
#define I2S_EXIT_CRITICAL_ISR(i2s_num)           portEXIT_CRITICAL_ISR()
#define I2S_ENTER_CRITICAL(i2s_num)              portENTER_CRITICAL()
#define I2S_EXIT_CRITICAL(i2s_num)               portEXIT_CRITICAL()
