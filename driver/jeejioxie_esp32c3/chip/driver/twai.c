...
#define TWAI_ENTER_CRITICAL_ISR()   portENTER_CRITICAL_ISR()
#define TWAI_EXIT_CRITICAL_ISR()    portEXIT_CRITICAL_ISR()
#define TWAI_ENTER_CRITICAL()       portENTER_CRITICAL()
#define TWAI_EXIT_CRITICAL()        portEXIT_CRITICAL()
