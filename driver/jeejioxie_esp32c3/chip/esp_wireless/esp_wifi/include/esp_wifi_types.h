...
typedef struct {
...
#elif CONFIG_JEEJIO_TARGET_ESP32S2 || CONFIG_JEEJIO_TARGET_ESP32S3 || CONFIG_JEEJIO_TARGET_ESP32C3 || CONFIG_JEEJIO_TARGET_ESP32C2
    unsigned :8;                  /**< reserved */
#endif
    ...
    unsigned :32;                 /**< reserved */
#elif CONFIG_JEEJIO_TARGET_ESP32S3 || CONFIG_JEEJIO_TARGET_ESP32C3 || CONFIG_JEEJIO_TARGET_ESP32C2
    signed noise_floor:8;         /**< noise floor of Radio Frequency Module(RF). unit: dBm*/
