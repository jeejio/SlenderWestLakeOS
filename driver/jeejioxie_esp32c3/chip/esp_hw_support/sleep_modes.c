...
#ifdef CONFIG_JEEJIO_TARGET_ESP32
...
#if CONFIG_JEEJIO_TARGET_ESP32S2 || CONFIG_JEEJIO_TARGET_ESP32S3
...
{
    for (int i = 0; i < SOC_UART_NUM; ++i) {
#ifndef CONFIG_JEEJIO_TARGET_ESP32
        if (!periph_ll_periph_enabled(PERIPH_UART0_MODULE + i)) {
            continue;
        }
#endif
...
#endif //CONFIG_JEEJIO_TARGET_ESP32S2
...
#elif CONFIG_RTC_CLK_SRC_INT_RC && CONFIG_JEEJIO_TARGET_ESP32S2
