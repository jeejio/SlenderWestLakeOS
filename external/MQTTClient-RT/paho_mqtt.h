...
#define MQTT_SW_VERSION "1.1.1"
#define MQTT_SW_VERSION_NUM 0x10101
...
typedef void (*mqtt_connect_callback_st)(MQTTClient *);
struct MQTTClient
{
    const char *uri;
    int sock;
    ...
    /* publish interface */
    SemaphoreHandle_t pub_sem; /* publish data semaphore for blocking */
