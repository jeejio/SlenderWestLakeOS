...
#                                           },
#
# for more information see the method "handle_commands" in esp_monitor.py


conf = {
    # the default values were previously hardcoded in esp_monitor.py (taken from esptool.py)
    'default': {
        0: {
            'reset': 0.2,
            'enter_boot_set': 0.1,
