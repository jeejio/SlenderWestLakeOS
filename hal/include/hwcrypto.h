...
#ifndef JEE_HWCRYPTO_DEFAULT_NAME
#define JEE_HWCRYPTO_DEFAULT_NAME    ("hwcryto")
#endif
...
struct jee_hwcrypto_ctx;

struct jee_hwcrypto_ops
{
    jee_err_t (*create)(struct jee_hwcrypto_ctx *ctx);        /**< Creating hardware context */
    void (*destroy)(struct jee_hwcrypto_ctx *ctx);           /**< Delete hardware context */
    jee_err_t (*copy)(struct jee_hwcrypto_ctx *des,
                     const struct jee_hwcrypto_ctx *src);    /**< Cpoy hardware context */
    void (*reset)(struct jee_hwcrypto_ctx *ctx);             /**< Reset hardware context */
};

struct jee_hwcrypto_device
{
    struct jee_device parent;                            /**< Inherited from the standard device */
    const struct jee_hwcrypto_ops *ops;                  /**< Hardware crypto ops */
    jee_uint64_t id;                                     /**< Unique id */
    void *user_data;                                    /**< Device user data */
};

struct jee_hwcrypto_ctx
{
    struct jee_hwcrypto_device *device;  /**< Binding device */
 ...
 */
jee_err_t jee_hwcrypto_set_type(struct jee_hwcrypto_ctx *ctx, hwcrypto_type type);
 ...
 * @param ctx       Crypto context
 */
void jee_hwcrypto_ctx_reset(struct jee_hwcrypto_ctx *ctx);
 ...
 * @return          JEE_EOK on success.
 */
jee_err_t jee_hwcrypto_ctx_init(struct jee_hwcrypto_ctx *ctx,
                              struct jee_hwcrypto_device *device, hwcrypto_type type);
 ...
 */
struct jee_hwcrypto_ctx *jee_hwcrypto_ctx_create(struct jee_hwcrypto_device *device,
                                               hwcrypto_type type, jee_uint32_t obj_size);
 ...
 */
void jee_hwcrypto_ctx_destroy(struct jee_hwcrypto_ctx *ctx);
 ...
 * @return          JEE_EOK on success.
 */
jee_err_t jee_hwcrypto_ctx_cpy(struct jee_hwcrypto_ctx *des, const struct jee_hwcrypto_ctx *src);
 ...
 * @return          JEE_EOK on success.
 */
jee_err_t jee_hwcrypto_register(struct jee_hwcrypto_device *device, const char *name);
 ...
 *
 */
struct jee_hwcrypto_device *jee_hwcrypto_dev_default(void);
 ...
 */
jee_uint64_t jee_hwcrypto_id(struct jee_hwcrypto_device *device);
