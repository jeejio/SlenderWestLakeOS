...
{
    jee_err_t (*prot_recv)(struct rt_wlan_device *wlan, void *buff, int len);
...
jee_err_t rt_wlan_prot_attach(const char *dev_name, const char *prot_name);

jee_err_t rt_wlan_prot_attach_dev(struct rt_wlan_device *wlan, const char *prot_name);

jee_err_t rt_wlan_prot_detach(const char *dev_name);

jee_err_t rt_wlan_prot_detach_dev(struct rt_wlan_device *wlan);

jee_err_t rt_wlan_prot_regisetr(struct rt_wlan_prot *prot);

jee_err_t rt_wlan_prot_transfer_dev(struct rt_wlan_device *wlan, void *buff, int len);

jee_err_t rt_wlan_dev_transfer_prot(struct rt_wlan_device *wlan, void *buff, int len);

jee_err_t rt_wlan_prot_event_register(struct rt_wlan_prot *prot, rt_wlan_prot_event_t event, rt_wlan_prot_event_handler handler);

jee_err_t rt_wlan_prot_event_unregister(struct rt_wlan_prot *prot, rt_wlan_prot_event_t event);
