...
#ifndef JEE_HWCRYPTO_IV_MAX_SIZE
#define JEE_HWCRYPTO_IV_MAX_SIZE  (16)
#endif
#ifndef JEE_HWCRYPTO_KEYBIT_MAX_SIZE
#define JEE_HWCRYPTO_KEYBIT_MAX_SIZE  (256)
#endif
...
{
    jee_err_t (*crypt)(struct hwcrypto_symmetric *symmetric_ctx,
...
struct hwcrypto_symmetric_info
{
    ...
    const jee_uint8_t *in;           /**< Input data */
    jee_uint8_t *out;                /**< Output data will be written */
    jee_size_t length;               /**< The length of the input data in Bytes. It's a multiple of block size. */
};
...
struct hwcrypto_symmetric
{
    ...
    jee_uint16_t flags;                                  /**< key or iv or ivoff has been changed. The flag will be set up */
    jee_uint16_t iv_len;                                 /**< initialization vector effective length */
    jee_uint16_t iv_off;                                 /**< The offset in IV */
    jee_uint16_t key_bitlen;                             /**< The crypto key bit length */
    jee_uint8_t iv[JEE_HWCRYPTO_IV_MAX_SIZE];             /**< The initialization vector */
    jee_uint8_t key[JEE_HWCRYPTO_KEYBIT_MAX_SIZE >> 3];   /**< The crypto key */
 ...
 */
struct jee_hwcrypto_ctx *jee_hwcrypto_symmetric_create(struct jee_hwcrypto_device *device,
        hwcrypto_type type);
 ...
 */
void jee_hwcrypto_symmetric_destroy(struct jee_hwcrypto_ctx *ctx);
 ...
 */
jee_err_t jee_hwcrypto_symmetric_crypt(struct jee_hwcrypto_ctx *ctx, hwcrypto_mode mode,
 ...
 * @return          JEE_EOK on success.
 */
jee_err_t jee_hwcrypto_symmetric_setkey(struct jee_hwcrypto_ctx *ctx, const jee_uint8_t *key, jee_uint32_t bitlen);
 ...
 */
int jee_hwcrypto_symmetric_getkey(struct jee_hwcrypto_ctx *ctx, jee_uint8_t *key, jee_uint32_t bitlen);
 ...
 * @return          JEE_EOK on success.
 */
jee_err_t jee_hwcrypto_symmetric_setiv(struct jee_hwcrypto_ctx *ctx, const jee_uint8_t *iv, jee_size_t len);
 ...
 */
int jee_hwcrypto_symmetric_getiv(struct jee_hwcrypto_ctx *ctx, jee_uint8_t *iv, jee_size_t len);
 ...
 */
void jee_hwcrypto_symmetric_set_ivoff(struct jee_hwcrypto_ctx *ctx, jee_int32_t iv_off);
 ...
 */
void jee_hwcrypto_symmetric_get_ivoff(struct jee_hwcrypto_ctx *ctx, jee_int32_t *iv_off);
 ...
 * @return          JEE_EOK on success.
 */
jee_err_t jee_hwcrypto_symmetric_cpy(struct jee_hwcrypto_ctx *des, const struct jee_hwcrypto_ctx *src);
 ...
 * @param ctx       Symmetric crypto context
 */
void jee_hwcrypto_symmetric_reset(struct jee_hwcrypto_ctx *ctx);
 ...
 * @return          JEE_EOK on success.
 */
jee_err_t jee_hwcrypto_symmetric_set_type(struct jee_hwcrypto_ctx *ctx, hwcrypto_type type);
