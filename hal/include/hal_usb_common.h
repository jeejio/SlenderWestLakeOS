 ...
 * Time of usb timeout
 */
#define TICK_PER_SECOND portTICK_PERIOD_MS * 1000
#ifndef USB_TIMEOUT_BASIC
#define USB_TIMEOUT_BASIC               (TICK_PER_SECOND)        /* 1s */
#endif
#ifndef USB_TIMEOUT_LONG
#define USB_TIMEOUT_LONG                (TICK_PER_SECOND * 5)    /* 5s */
#endif
#ifndef USB_DEBOUNCE_TIME
#define USB_DEBOUNCE_TIME               (TICK_PER_SECOND / 5)    /* 0.2s */
#endif
...
#define  uswap_8(x) \
    (((jee_uint16_t)(*((jee_uint8_t *)(x)))) + \
    (((jee_uint16_t)(*(((jee_uint8_t *)(x)) + 1))) << 8))
...
struct udevice_descriptor
{
    ...
    jee_uint8_t type;
    jee_uint16_t bcdUSB;
    jee_uint8_t bDeviceClass;
    jee_uint8_t bDeviceSubClass;
    jee_uint8_t bDeviceProtocol;
    jee_uint8_t bMaxPacketSize0;
    jee_uint16_t idVendor;
    jee_uint16_t idProduct;
    jee_uint16_t bcdDevice;
    jee_uint8_t iManufacturer;
    jee_uint8_t iProduct;
    jee_uint8_t iSerialNumber;
    jee_uint8_t bNumConfigurations;
};
...
struct uconfig_descriptor
{
    jee_uint8_t bLength;
    jee_uint8_t type;
    jee_uint16_t wTotalLength;
    jee_uint8_t bNumInterfaces;
    jee_uint8_t bConfigurationValue;
    jee_uint8_t iConfiguration;
    jee_uint8_t bmAttributes;
    jee_uint8_t MaxPower;
    jee_uint8_t data[2048];
};
...
struct uinterface_descriptor
{
    jee_uint8_t bLength;
    jee_uint8_t type;
    jee_uint8_t bInterfaceNumber;
    jee_uint8_t bAlternateSetting;
    jee_uint8_t bNumEndpoints;
    jee_uint8_t bInterfaceClass;
    jee_uint8_t bInterfaceSubClass;
    jee_uint8_t bInterfaceProtocol;
    jee_uint8_t iInterface;
};
...
{
    jee_uint8_t bLength;
    jee_uint8_t bDescriptorType;
    jee_uint8_t bFirstInterface;
    jee_uint8_t bInterfaceCount;
    jee_uint8_t bFunctionClass;
    jee_uint8_t bFunctionSubClass;
    jee_uint8_t bFunctionProtocol;
    jee_uint8_t iFunction;
};
...
struct uendpoint_descriptor
{
    jee_uint8_t  bLength;
    jee_uint8_t  type;
    jee_uint8_t  bEndpointAddress;
    jee_uint8_t  bmAttributes;
    jee_uint16_t wMaxPacketSize;
    jee_uint8_t  bInterval;
};
...
struct uhub_descriptor
{
    ...
    jee_uint16_t characteristics;
    jee_uint8_t pwron_to_good;        /* power on to power good */
    jee_uint8_t current;
    jee_uint8_t removable[8];
    jee_uint8_t pwr_ctl[8];
};
...
struct usb_qualifier_descriptor
{
    ...
    jee_uint16_t bcdUSB; // TODO: big-endian.
    jee_uint8_t  bDeviceClass;
    jee_uint8_t  bDeviceSubClass;
    jee_uint8_t  bDeviceProtocol;
    jee_uint8_t  bMaxPacketSize0;
    jee_uint8_t  bNumConfigurations;
    jee_uint8_t  bRESERVED;
} __attribute__ ((packed));

struct usb_os_header_comp_id_descriptor
{
    jee_uint32_t dwLength;
    jee_uint16_t bcdVersion;
    jee_uint16_t wIndex;
    jee_uint8_t  bCount;
    jee_uint8_t  reserved[7];
};
...
{
    jee_uint32_t dwSize;
    jee_uint32_t dwPropertyDataType;
    jee_uint16_t wPropertyNameLength;
    const char * bPropertyName;
    jee_uint32_t dwPropertyDataLength;
...
struct uhid_descriptor
{
    ...
    jee_uint8_t  type;
    jee_uint16_t bcdHID;
    jee_uint8_t  bCountryCode;
    jee_uint8_t  bNumDescriptors;
    struct hid_descriptor_list
    {
        jee_uint8_t type;
        jee_uint16_t wLength;
...
struct hid_report
{
    jee_uint8_t report_id;
    jee_uint8_t report[63];
    jee_uint8_t size;
};
...
struct urequest
{
    jee_uint8_t  request_type;
    jee_uint8_t  bRequest;
    jee_uint16_t wValue;
    jee_uint16_t wIndex;
    jee_uint16_t wLength;
};
...
struct ustorage_cbw
{
    jee_uint32_t signature;
    jee_uint32_t tag;
    jee_uint32_t xfer_len;
    jee_uint8_t dflags;
    jee_uint8_t lun;
    jee_uint8_t cb_len;
    jee_uint8_t cb[16];
...
{
    jee_list_t list;
    jee_uint8_t bFirstInterfaceNumber;
    jee_uint8_t reserved1;
    jee_uint8_t compatibleID[8];
    jee_uint8_t subCompatibleID[8];
    jee_uint8_t reserved2[6];
};
...
#ifndef JEE_USBD_THREAD_STACK_SZ
#define JEE_USBD_THREAD_STACK_SZ 512
#endif

/* the priority of USB thread */
#ifndef JEE_USBD_THREAD_PRIO
#define JEE_USBD_THREAD_PRIO 8
#endif
